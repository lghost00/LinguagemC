// Programa para mostrar o valor do desconto e preço final do produto
#include <stdio.h> 
int main (){
...
o programa divide por 100 para obter o valor em percentual.Sendo assim, quando o vendedor digitar 5, 
